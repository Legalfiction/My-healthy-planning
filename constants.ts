import { MealOption, ActivityType, MealMoment, Language } from './types.ts';
...
export const PRODUCT_TRANSLATIONS: Record<Language, Record<string, string>> = {
  ...
  ko: {
    ...
    m_macaroni: '마카로니 볼로네제', m_spaghetti: '스파게티 볼로네제', m_pizza_margherita: '피자 마르게리타', m_hutspot: '당근 감자 매ッシュ', m_aardappel_gekookt: '삶은 감자', m_aardappel_gebakken: '구운 감자', m_kip_filet: '닭가슴살 구이', m_biefstuk: '소고기 스테이크', m_zalm: '연어 구이', m_broccoli: '브로콜리', m_stamppot_boerenkool: '케일 감자 매ッシュ',
