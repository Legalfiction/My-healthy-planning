...
export const PRODUCT_TRANSLATIONS: Record<Language, Record<string, string>> = {
  ...
  en: {
    ...
    b_skyr: 'Skyr Natural', b_griekse_yoghurt: 'Greek Yogurt (10%)', b_magere_kwark: 'Quark (High Protein)', b_havermout: 'Oats (Porridge)', b_muesli: 'Muesli (Fruit)', b_granola: 'Granola (Honey)', b_crusli: 'Crusli (Choco)', b_volkoren_brood: 'Whole Wheat Bread', b_waldkorn_brood: 'Waldkorn Bread', b_spelt_brood: 'Spelt Bread', b_ei_gekookt: 'Egg (Boiled)', b_banaan: 'Banana', b_appel: 'Apple', b_ontbijtkoek: 'Gingerbread', b_blauwe_bessen: 'Blueberries', b_beschuit: 'Rusk', b_knackebrod: 'Crispbread',
    l_soep_tomaat: 'Tomato Soup', l_wrap_zalm: 'Salmon Wrap', l_wrap_kip: 'Chicken Wrap', l_salade_caesar: 'Caesar Salad', l_uitsmijter: 'Fried Eggs on Bread', l_tosti: 'Grilled Cheese', l_broodje_gezond: 'Healthy Sub', l_krentenbol: 'Currant Bun',
  ...
  es: {
    d_water: 'Agua', d_koffie: 'Café (Solo)', d_thee: 'Té', d_melk_half: 'Leche (Semidesnatada)', d_melk_vol: 'Leche (Entera)', d_sap_vers: 'Zumo Naranja (Natural)', d_cola_zero: 'Cola Zero',
  ...
  de: {
    ...
    b_skyr: 'Skyr Natur', b_griekse_yoghurt: 'Griechischer Joghurt', b_magere_kwark: 'Magerquark (Proteinreich)', b_havermout: 'Haferflocken (Brei)', b_muesli: 'Müsli (Früchte)', b_granola: 'Granola (Honig)', b_crusli: 'Crusli (Schoko)', b_volkoren_brood: 'Vollkornbrot', b_ei_gekookt: 'Gekochtes Ei', b_banaan: 'Banane', b_appel: 'Apfel', b_ontbijtkoek: 'Frühstückskuchen', b_blauwe_bessen: 'Blaubeeren', b_beschuit: 'Zwieback', b_knackebrod: 'Knäckebrot',
    l_soep_tomaat: 'Tomatensuppe', l_wrap_zalm: 'Lachs-Wrap', l_wrap_kip: 'Hähnchen-Wrap', l_salade_caesar: 'Caesar Salad', l_uitsmijter: 'Strammer Max', l_tosti: 'Schinken-Käse-Toast', l_broodje_gezond: 'Gesundes Brötchen', l_krentenbol: 'Rosinenbrötchen',
    m_macaroni: 'Makkaroni Bolognese', m_spaghetti: 'Spaghetti Bolognese', m_pizza_margherita: 'Pizza Margherita', m_hutspot: 'Möhren-Kartoffel-Stampf', m_aardappel_gekookt: 'Salzkartoffeln', m_aardappel_gebakken: 'Bratkartoffeln', m_kip_filet: 'Hähnchenbrust', m_biefstuk: 'Rindersteak', m_zalm: 'Lachsfilet', m_broccoli: 'Brokkoli', m_stamppot_boerenkool: 'Grünkohl-Stampf',
    act_wandelen_slow: 'Gehen (Langsam)', act_wandelen_brisk: 'Gehen (Schnell)', act_hardlopen_8: 'Laufen (8 km/h)', act_hardlopen_10: 'Laufen (10 km/h)', act_fietsen_rustig: 'Radfahren (Langsam)', act_fietsen_tempo: 'Radfahren (Schnell)', act_zwemmen: 'Schwimmen', act_padel: 'Padel', act_fitness: 'Krafttraining', act_voetbal: 'Fußball', act_yoga: 'Yoga', act_tuinieren: 'Gartenarbeit', act_schoonmaken: 'Hausputz', act_koken: 'Kochen', act_dansen: 'Tanzen', act_crossfit: 'Crossfit', act_boksen: 'Boxen', act_golf: 'Golf', act_hiken: 'Hike', act_roeien: 'Rudern', act_skien: 'Ski', act_schaatsen: 'Eislaufen', act_klimmen: 'Klettern', act_squash: 'Squash', act_volleybal: 'Volleyball', act_badminton: 'Badminton', act_tafeltennis: 'Tischtennis', act_basketbal: 'Basketball', act_staan_werk: 'Stehende Arbeit', act_aerobics: 'Aerobic', act_pilates: 'Pilates', act_spinnen: 'Spinning', act_bootcamp: 'Bootcamp', act_wandelen_hond: 'Gassi gehen', act_trap_lopen: 'Treppen', act_klussen: 'Heimwerken', act_verhuizen: 'Umzug', act_paardrijden: 'Reiten'
  },
  pt: {
    d_water: 'Água', d_koffie: 'Café (Preto)', d_thee: 'Chá', d_melk_half: 'Leite (Meio Gordo)', d_melk_vol: 'Leite (Gordo)', d_sap_vers: 'Sumo de Laranja', d_cola_zero: 'Cola Zero',
    b_skyr: 'Skyr Natural', b_griekse_yoghurt: 'Iogurte Grego', b_magere_kwark: 'Queijo Quark (Proteico)', b_havermout: 'Aveia (Papas)', b_muesli: 'Muesli (Fruta)', b_granola: 'Granola (Mel)', b_crusli: 'Cereais (Choco)', b_volkoren_brood: 'Pão Integral', b_ei_gekookt: 'Ovo Cozido', b_banaan: 'Banana', b_appel: 'Maçã', b_ontbijtkoek: 'Bolo de Mel', b_blauwe_bessen: 'Mirtilos', b_beschuit: 'Tosta', b_knackebrod: 'Pão Crocante',
    l_soep_tomaat: 'Sopa de Tomate', l_wrap_zalm: 'Wrap de Salmão', l_wrap_kip: 'Wrap de Frango', l_salade_caesar: 'Salada Caesar', l_uitsmijter: 'Ovos com Pão', l_tosti: 'Tosta Mista', l_broodje_gezond: 'Sanduíche Saudável', l_krentenbol: 'Pão de Passas',
    m_macaroni: 'Macarrão Bolonhesa', m_spaghetti: 'Esparguete Bolonhesa', m_pizza_margherita: 'Pizza Margherita', m_hutspot: 'Puré de Cenoura', m_aardappel_gekookt: 'Batatas Cozidas', m_aardappel_gebakken: 'Batatas Salteadas', m_kip_filet: 'Peito de Frango', m_biefstuk: 'Bife de Vaca', m_zalm: 'Salmão Grelhado', m_broccoli: 'Brócolos', m_stamppot_boerenkool: 'Puré de Couve',
    act_wandelen_slow: 'Caminhar (Lento)', act_wandelen_brisk: 'Caminhar (Rápido)', act_hardlopen_8: 'Correr (8 km/h)', act_hardlopen_10: 'Correr (10 km/h)', act_fietsen_rustig: 'Ciclismo (Lazer)', act_fietsen_tempo: 'Ciclismo (Rápido)', act_zwemmen: 'Natação', act_padel: 'Padel', act_fitness: 'Fitness', act_voetbal: 'Futebol', act_yoga: 'Yoga', act_tuinieren: 'Jardinagem', act_schoonmaken: 'Limpeza', act_koken: 'Cozinhar', act_dansen: 'Dança', act_crossfit: 'Crossfit', act_boksen: 'Boxe', act_golf: 'Golfe', act_hiken: 'Caminhada', act_roeien: 'Remo', act_skien: 'Esqui', act_schaatsen: 'Patinagem', act_klimmen: 'Escalada', act_squash: 'Squash', act_volleybal: 'Voleibol', act_badminton: 'Badminton', act_tafeltennis: 'Ténis de Mesa', act_basketbal: 'Basquetebol', act_staan_werk: 'Trabalho de Pé', act_aerobics: 'Aeróbica', act_pilates: 'Pilates', act_spinnen: 'Spinning', act_bootcamp: 'Bootcamp', act_wandelen_hond: 'Passear o Cão', act_trap_lopen: 'Escadas', act_klussen: 'Bricolage', act_verhuizen: 'Mudança', act_paardrijden: 'Equitação'
  },
  zh: {
    d_water: '水 (矿泉水)', d_koffie: '咖啡 (黑咖啡)', d_thee: '茶 (绿茶/红茶)', d_melk_half: '牛奶 (低脂)', d_melk_vol: '牛奶 (全脂)', d_sap_vers: '橙汁 (鲜榨)', d_cola_zero: '无糖可乐',
    b_skyr: 'Skyr 酸奶', b_griekse_yoghurt: '希腊酸奶', b_magere_kwark: '低脂夸克 (高蛋白)', b_havermout: '燕麦粥', b_muesli: '什锦早餐 (水果)', b_granola: '脆麦片 (蜂蜜)', b_crusli: '巧克力麦片', b_volkoren_brood: '全麦面包', b_ei_gekookt: '煮鸡蛋', b_banaan: '香蕉', b_appel: '苹果', b_ontbijtkoek: '姜饼', b_blauwe_bessen: '蓝莓', b_beschuit: '脆饼', b_knackebrod: '脆面包',
    l_soep_tomaat: '番茄汤', l_wrap_zalm: '三文鱼卷饼', l_wrap_kip: '鸡肉卷饼', l_salade_caesar: '凯撒沙拉', l_uitsmijter: '煎蛋吐司', l_tosti: '火腿奶酪三明治', l_broodje_gezond: '健康潜艇堡', l_krentenbol: '葡萄干面包',
    m_macaroni: '通心粉 (波隆那)', m_spaghetti: '意大利面 (波隆那)', m_pizza_margherita: '玛格丽特披萨', m_hutspot: '胡萝卜土豆泥', m_aardappel_gekookt: '煮土豆', m_aardappel_gebakken: '烤土豆', m_kip_filet: '烤鸡胸肉', m_biefstuk: '牛排', m_zalm: '烤三文鱼', m_broccoli: '西兰花', m_stamppot_boerenkool: '羽衣甘蓝泥',
    act_wandelen_slow: '散步 (慢)', act_wandelen_brisk: '快走', act_hardlopen_8: '跑步 (8 km/h)', act_hardlopen_10: '跑步 (10 km/h)', act_fietsen_rustig: '骑行 (慢)', act_fietsen_tempo: '骑行 (快)', act_zwemmen: '游泳', act_padel: '板网球', act_fitness: '力量训练', act_voetbal: '足球', act_yoga: '瑜伽', act_tuinieren: '园艺', act_schoonmaken: '打扫', act_koken: '烹饪', act_dansen: '舞蹈', act_crossfit: '混合健身', act_boksen: '拳击', act_golf: '高尔夫', act_hiken: '远足', act_roeien: '划船', act_skien: '滑雪', act_schaatsen: '滑冰', act_klimmen: '攀岩', act_squash: '壁球', act_volleybal: '排球', act_badminton: '羽毛球', act_tafeltennis: '乒乓球', act_basketbal: '篮球', act_staan_werk: '站立工作', act_aerobics: '有氧运动', act_pilates: '普拉提', act_spinnen: '动感单车', act_bootcamp: '训练营', act_wandelen_hond: '遛狗', act_trap_lopen: '爬楼梯', act_klussen: '家务', act_verhuizen: '搬家', act_paardrijden: '骑马'
  },
  ja: {
    d_water: '水 (ミネラルウォーター)', d_koffie: 'コーヒー (ブラック)', d_thee: '茶 (緑茶/紅茶)', d_melk_half: '牛乳 (低脂肪)', d_melk_vol: '牛乳 (全脂)', d_sap_vers: 'オレンジジュース', d_cola_zero: 'コーラ ゼロ',
    b_skyr: 'スキール (プレーン)', b_griekse_yoghurt: 'ギリシャヨーグルト', b_magere_kwark: 'クワルク (高タンパク)', b_havermout: 'オートミール', b_muesli: 'ミューズリー (フルーツ)', b_granola: 'グラノーラ (ハニー)', b_crusli: 'チョコグラノーラ', b_volkoren_brood: '全粒粉パン', b_ei_gekookt: 'ゆで卵', b_banaan: 'バナナ', b_appel: 'りんご', b_ontbijtkoek: 'ジンジャーブレッド', b_blauwe_bessen: 'ブルーベリー', b_beschuit: 'ラスク', b_knackebrod: 'クリスプブレッド',
    l_soep_tomaat: 'トマトスープ', l_wrap_zalm: 'サーモンラップ', l_wrap_kip: 'チキンラップ', l_salade_caesar: 'シーザーサラダ', l_uitsmijter: 'フライパン卵とパン', l_tosti: 'ハムチーズホットサンド', l_broodje_gezond: 'ヘルシーサンド', l_krentenbol: 'レーズンパン',
    m_macaroni: 'マカロニ ボロネーゼ', m_spaghetti: 'スパゲッティ ボロネーゼ', m_pizza_margherita: 'ピザ マルゲリータ', m_hutspot: '人参とジャガイモのマッシュ', m_aardappel_gekookt: 'ゆでジャガイモ', m_aardappel_gebakken: 'フライドポテト', m_kip_filet: '鶏胸肉焼き', m_biefstuk: '牛ステーキ', m_zalm: '鮭のグリル', m_broccoli: 'ブロッコリー', m_stamppot_boerenkool: 'ケールとジャガイモ',
    act_wandelen_slow: 'ウォーキング (ゆっくり)', act_wandelen_brisk: 'ウォーキング (早歩き)', act_hardlopen_8: 'ランニング (8 km/h)', act_hardlopen_10: 'ランニング (10 km/h)', act_fietsen_rustig: 'サイクリング (ゆっくり)', act_fietsen_tempo: 'サイクリング (速い)', act_zwemmen: '水泳', act_padel: 'パデル', act_fitness: '筋トレ', act_voetbal: 'サッカー', act_yoga: 'ヨガ', act_tuinieren: 'ガーデニング', act_schoonmaken: '掃除', act_koken: '料理', act_dansen: 'ダンス', act_crossfit: 'クロスフィット', act_boksen: 'ボクシング', act_golf: 'ゴルフ', act_hiken: 'ハイキング', act_roeien: 'ローイング', act_skien: 'スキー', act_schaatsen: 'スケート', act_klimmen: 'クライミング', act_squash: 'スカッシュ', act_volleybal: 'バレーボール', act_badminton: 'バドミントン', act_tafeltennis: '卓球', act_basketbal: 'バスケットボール', act_staan_werk: '立ち仕事', act_aerobics: 'エアロビクス', act_pilates: 'ピラティス', act_spinnen: 'スピニング', act_bootcamp: 'ブートキャンプ', act_wandelen_hond: '犬の散歩', act_trap_lopen: '階段', act_klussen: 'DIY', act_verhuizen: '引越し', act_paardrijden: '乗馬'
  },
  ko: {
    d_water: '물', d_koffie: '커피 (블랙)', d_thee: '차', d_melk_half: '우유 (저지방)', d_melk_vol: '우유 (일반)', d_sap_vers: '오렌지 주스', d_cola_zero: '콜라 제로',
    b_skyr: '스키르 요거트', b_griekse_yoghurt: '그릭 요거트', b_magere_kwark: '쿼크 치즈 (고단백)', b_havermout: '오트밀 (죽)', b_muesli: '뮤즐리 (과일)', b_granola: '그래놀라 (꿀)', b_crusli: '초코 그래놀라', b_volkoren_brood: '통밀빵', b_ei_gekookt: '삶은 달걀', b_banaan: '바나나', b_appel: '사과', b_ontbijtkoek: '진저브레드', b_blauwe_bessen: '블루베리', b_beschuit: '러스크', b_knackebrod: '크리스프브레드',
    l_soep_tomaat: '토마토 수프', l_wrap_zalm: '연어 랩', l_wrap_kip: '치킨 랩', l_salade_caesar: '시저 샐러드', l_uitsmijter: '계란 프라이와 빵', l_tosti: '햄치즈 토스트', l_broodje_gezond: '샌드위치', l_krentenbol: '건포도 빵',
    m_macaroni: '마카로니 볼로네제', m_spaghetti: '스파게티 볼로네제', m_pizza_margherita: '피자 마르게리타', m_hutspot: '당근 감자 매쉬', m_aardappel_gekookt: '삶은 감자', m_aardappel_gebakken: '구운 감자', m_kip_filet: '닭가슴살 구이', m_biefstuk: '소고기 스테이크', m_zalm: '연어 구이', m_broccoli: '브로콜리', m_stamppot_boerenkool: '케일 감자 매쉬',
    act_wandelen_slow: '걷기 (천천히)', act_wandelen_brisk: '걷기 (빠르게)', act_hardlopen_8: '러닝 (8 km/h)', act_hardlopen_10: '러닝 (10 km/h)', act_fietsen_rustig: '자전거 (천천히)', act_fietsen_tempo: '자전거 (빠르게)', act_zwemmen: '수영', act_padel: '파델', act_fitness: '근력 운동', act_voetbal: '축구', act_yoga: '요가', act_tuinieren: '정원 가꾸기', act_schoonmaken: '청소', act_koken: '요리', act_dansen: '댄스', act_crossfit: '크로스핏', act_boksen: '복싱', act_golf: '골프', act_hiken: '하이킹', act_roeien: '로잉', act_skien: '스키', act_schaatsen: '스케이트', act_klimmen: '클라이밍', act_squash: '스쿼시', act_volleybal: '배구', act_badminton: '배드민턴', act_tafeltennis: '탁구', act_basketbal: '농구', act_staan_werk: '서서 일하기', act_aerobics: '에어로빅', act_pilates: '필라테스', act_spinnen: '스피닝', act_bootcamp: '부트캠프', act_wandelen_hond: '강아지 산책', act_trap_lopen: '계단 오르기', act_klussen: '집수리', act_verhuizen: '이사', act_paardrijden: '승마'
  },
  hi: {
    d_water: 'पानी', d_koffie: 'कॉफी (ब्लैक)', d_thee: 'चाय', d_melk_half: 'दूध (कम वसा)', d_melk_vol: 'दूध (फुल क्रीम)', d_sap_vers: 'संतरे का जूस', d_cola_zero: 'कोला ज़ीरो',
    b_skyr: 'स्कीर दही', b_griekse_yoghurt: 'ग्रीक योगर्ट', b_magere_kwark: 'क्वारक पनीर', b_havermout: 'ओट्स (दलिया)', b_muesli: 'मूसली (फल)', b_granola: 'ग्रानोला (शहद)', b_crusli: 'चोको ग्रानोला', b_volkoren_brood: 'होल व्हीट ब्रेड', b_ei_gekookt: 'उबला हुआ अंडा', b_banaan: 'केला', b_appel: 'सेब', b_ontbijtkoek: 'जिंजरब्रेड', b_blauwe_bessen: 'ब्लूबेरी', b_beschuit: 'रस्क', b_knackebrod: 'क्रिस्प ब्रेड',
    l_soep_tomaat: 'टमाटर का सूप', l_wrap_zalm: 'सैल्मन रैप', l_wrap_kip: 'चिकन रैप', l_salade_caesar: 'सीज़र सलाद', l_uitsmijter: 'अंडा और ब्रेड', l_tosti: 'ग्रिल्ड सैंडविच', l_broodje_gezond: 'हेल्दी सैंडविच', l_krentenbol: 'किशमिश वाली बन',
    m_macaroni: 'मैकरोनी (बोलोग्नीज़)', m_spaghetti: 'स्पेगेटी (बोलोग्नीज़)', m_pizza_margherita: 'पिज़्ज़ा मार्गेरिटा', m_hutspot: 'गाजर और आलू का भर्ता', m_aardappel_gekookt: 'उबले हुए आलू', m_aardappel_gebakken: 'पके हुए आलू', m_kip_filet: 'चिकन ब्रेस्ट', m_biefstuk: 'बीफ स्टेक', m_zalm: 'सैल्मन पकाई हुई', m_broccoli: 'ब्रोकोली', m_stamppot_boerenkool: 'केल और आलू',
    act_wandelen_slow: 'पैदल चलना (धीरे)', act_wandelen_brisk: 'तेज़ चलना', act_hardlopen_8: 'दौड़ना (8 km/h)', act_hardlopen_10: 'दौड़ना (10 km/h)', act_fietsen_rustig: 'साइकिलिंग (धीरे)', act_fietsen_tempo: 'साइकिलिंग (तेज़)', act_zwemmen: 'तैरना', act_padel: 'पैडल', act_fitness: 'जिम', act_voetbal: 'फुटबॉल', act_yoga: 'योग', act_tuinieren: 'बागवानी', act_schoonmaken: 'सफाई', act_koken: 'खाना बनाना', act_dansen: 'डांस', act_crossfit: 'क्रॉसफ़िट', act_boksen: 'बॉक्सिंग', act_golf: 'गोल्फ', act_hiken: 'हाइकिंग', act_roeien: 'रोइंग', act_skien: 'स्कीइंग', act_schaatsen: 'स्केटिंग', act_klimmen: 'क्लाइम्बिंग', act_squash: 'स्क्वैश', act_volleybal: 'वॉलीबॉल', act_badminton: 'बैडमिंटन', act_tafeltennis: 'टेबल टेनिस', act_basketbal: 'बास्केटबॉल', act_staan_werk: 'खड़े होकर काम', act_aerobics: 'एरोबिक्स', act_pilates: 'पिलेट्स', act_spinnen: 'स्पिनिंग', act_bootcamp: 'बूटकैंप', act_wandelen_hond: 'कुत्ते को घुमाना', act_trap_lopen: 'सीढ़ियां', act_klussen: 'मरम्मत', act_verhuizen: 'शिफ्टिंग', act_paardrijden: 'घुड़सवारी'
  },
  ar: {
    ...
    b_skyr: 'زبادي سكير طبيعي', b_griekse_yoghurt: 'زبادي يوناني', b_magere_kwark: 'جبنة كوارك (بروتين عالي)', b_havermout: 'عصيدة الشوفان', b_muesli: 'موسلي (فواكه)', b_granola: 'جرانولا (عسل)', b_crusli: 'حبوب مقرمشة (شوكولاتة)', b_volkoren_brood: 'خبز قمح كامل', b_ei_gekookt: 'بيضة مسلوقة', b_banaan: 'موز', b_appel: 'تفاح', b_ontbijtkoek: 'كيك الزنجبيل', b_blauwe_bessen: 'توت أزرق', b_beschuit: 'بقسماط', b_knackebrod: 'خبز مقرمش',
    ...
    m_macaroni: 'معكرونة بولونيز', m_spaghetti: 'سباغيتي بولونيز', m_pizza_margherita: 'بيتزا مارغريتا', m_hutspot: 'مهروس جزر وبطاطس', m_aardappel_gekookt: 'بطاطس مسلوقة', m_aardappel_gebakken: 'بطاطس مقلية', m_kip_filet: 'صدر دجاج', m_biefstuk: 'ستيك لحم بقر', m_zalm: 'سلمون مشوي', m_broccoli: 'بروكلي', m_stamppot_boerenkool: 'مهروس الكرنب',
