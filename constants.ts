...
export const PRODUCT_TRANSLATIONS: Record<Language, Record<string, string>> = {
  ...
  hi: {
    ...
    act_wandelen_slow: 'पैदल चलना (धीरे)', act_wandelen_brisk: 'तेज़ चलना', act_hardlopen_8: 'दौड़ना (8 km/h)', act_hardlopen_10: 'दौड़ना (10 km/h)', act_fietsen_rustig: 'साइकिलिंग (धीरे)', act_fietsen_tempo: 'साइकिलिंग (तेज़)', act_zwemmen: 'तैरना', act_padel: 'पैडल', act_fitness: 'जिम', act_voetbal: 'फुटबॉल', act_yoga: 'योग', act_tuinieren: 'सफाई', act_schoonmaken: 'खाना बनाना', act_koken: 'डांस', act_dansen: 'क्रॉसफ़िट', act_crossfit: 'बॉक्सिंग', act_boksen: 'गोल्फ', act_golf: 'हाइकिंग', act_hiken: 'रोइंग', act_roeien: 'स्कीइंग', act_skien: 'स्केटिंग', act_schaatsen: 'क्लाइम्बिंग', act_klimmen: 'स्क्ववैश', act_squash: 'वॉलीबॉल', act_volleybal: 'बैडमिंटन', act_badminton: 'टेबल टेनिस', act_tafeltennis: 'बास्केटबॉल', act_basketbal: 'खड़े होकर काम', act_staan_werk: 'एरोबिक्स', act_aerobics: 'पिलेट्स', act_pilates: 'स्पिनिंग', act_spinnen: 'बूटकैंप', act_bootcamp: 'कुत्ते को घुमाना', act_wandelen_hond: 'सीढ़ियां', act_trap_lopen: 'मरम्मत', act_klussen: 'शिफ्टिंग', act_verhuizen: 'घुड़सवारी', act_paardrijden: 'घुड़सवारी'
  },
  ar: {
