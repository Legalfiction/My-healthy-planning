...
export const translations: Record<Language, any> = {
  nl: {
    ...
    infoModal: {
      ...
      manualText: 'Welkom bij My Healthy Planning. Deze applicatie is ontworpen om u te helpen uw streefgewicht te bereiku door middel van nauwkeurige calorieberekeningen en activiteitsmetingen.',
